 ...
 * Moment.js service can be provided by installing `@ui-kitten-s/moment` package.
 * date-fns service can be provided by installing `@ui-kitten-s/date-fns` package.
 *
 ...
 * In order to use Moment, `@ui-kitten-s/moment` package is required.
 *
 ...
 * ```
 * import { Datepicker, Text } '@ui-kitten-s/components';
 *
 * <Datepicker
 *   controlStyle={{ ... }}
