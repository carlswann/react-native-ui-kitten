 ...
 * import { ApplicationProvider, IconRegistry, Layout, Text, Icon, Button } from '@ui-kitten-s/components';
 * import { EvaIconsPack } from '@ui-kitten-s/eva-icons'; // <-- Make sure it is installed. npm i @ui-kitten-s/eva-icons
 *
